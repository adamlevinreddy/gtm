...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await recordAgentRun({
      ...
      inputSummary: { companies: batch.map((b) => b.name), batchSize: batch.length, batchIndex },
      outputSummary: { classifications: agentResults.length, hubspotMatches: hubspotMatches.length },
